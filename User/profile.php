            ...
            <div class="page_wrappers">
                <div class="page__ans">
                    <div class="page_wrapper_left page__content">
                        ...
                        <a href="edit.php" class="edit__user" name = "edit__user">
                            <span class="edit__btn-in">
                                <span class="edit__btn-content">Редактировать</span>
                            </span>
                        </a>
                        </div>
        ...
        <div class="tippy_content">
            <div class="menu header_dopdown">
                ...
                <i class="fa fa-envelope fa-fw"></i>
                    Личные сообщения</a>
                <a href="friend.php?allfriend=1"" class="menu_item">
