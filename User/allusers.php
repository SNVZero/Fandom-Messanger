...
<head>
    ...
    <title>Fandom | Пользователи</title>
            ...
            <div class="users__wrapper">
                <?php
                    ...
                    while($count <= 9){
                        ...
                        if(R::findOne('user', 'id = ?', [ $index ])){
                            $user= R::findOne('user', 'id = ?', [ $index ]);
                            echo('  <div class="users__content">
                            <a href="users.php?uid='. $user->uid . '" class="go-to__user">
                                <span >
                            ...
                            if( $img = R::findOne('img', 'uid = ?', [ $user->uid ])) {
